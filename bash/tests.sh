...
echo "..............IMPROVE..............."
# TASK 1: Add a test to see if the /etc/resolv.conf file is a regular file
test -f /etc/resolv.conf && echo "/etc/resolv.conf exists and is a regular file" || echo "/etc/resolv.conf does not exists or is not a regular file"
# TASK 2: Add a test to see if the /etc/resolv.conf file is a symbolic link
test -s /etc/resolv.conf && echo "/etc/resolv.conf exists and is a symbolic link" || echo "/etc/resolv.conf does not exists or is not a symbolic link"
# TASK 3: Add a test to see if the /etc/resolv.conf file is a directory
test -d /etc/resolv.conf && echo "/etc/resolv.conf exists and is a directory" || echo "/etc/resolv.conf does not exists or is not a directory"
# TASK 4: Add a test to see if the /etc/resolv.conf file is readable
test -r /etc/resolv.conf && echo "/etc/resolv.conf exists and is readable" || echo "/etc/resolv.conf does not exists or is not readable"
# TASK 5: Add a test to see if the /etc/resolv.conf file is writable
test -w /etc/resolv.conf && echo "/etc/resolv.conf exists and is writable" || echo "/etc/resolv.conf does not exists or is not writable"
# TASK 6: Add a test to see if the /etc/resolv.conf file is executable
test -x /etc/resolv.conf && echo "/etc/resolv.conf exists and is executable" || echo "/etc/resolv.conf does not exists or is not executable"
